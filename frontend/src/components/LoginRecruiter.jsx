...
const LoginRecruiter = () => {
  ...
  const onSubmit = async e => {
    e.preventDefault();
    try {
      const res = await axios.post('http://localhost:5000/api/auth/login/recruiter', formData);
  ...
  return (
    <div className='container'>
      <h3 style={{background: "linear-gradient(90deg, #3F2B96 0%, #A8C0FF 100%", border: 'solid 1px black', borderRadius: '5px', padding: '10px', color: 'white'}} >Login as Recruiter</h3>
